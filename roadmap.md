...
|----------|--------------------------------------|----------------------------------------------------------------------------------|-------------------------------------------------------------|------------------|---------------------|-----------------|--------------|
| **1**    | **Full MCP Support**                 | Model Context Protocol (server + client) + automatic tool discovery              | 2026 Standard (Deer-Flow has it natively)                   | Medium           | ★★★★★ (game-changer) | **Planned**     | May 2026     |
| **2**    | **Web UI / Dashboard**               | Streamlit or FastAPI + React Lite (visual memory, swarms, jobs, knowledge base)  | Agno & Deer-Flow have UIs → users demand visibility         | Medium           | ★★★★                | **Planned**     | June 2026    |
...
| **8**    | **Improved CLI + VS Code Ext.**      | Advanced commands + VS Code extension                                            | Developers want the agent right inside their editor         | Low              | ★★★                 | Planned         | Q1 2027      |
